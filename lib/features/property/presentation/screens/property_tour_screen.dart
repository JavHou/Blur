...
class PropertyTourScreen extends StatefulWidget {
  const PropertyTourScreen({super.key});

  @override
  State<PropertyTourScreen> createState() => _PropertyTourScreenState();
}

class _PropertyTourScreenState extends State<PropertyTourScreen> {
      ...
      bottomNavigationBar: BottomAppBar(
        child: Container(
          ...
          child: FullWidthButton(
            text:  _currentStep <= 1 ? 'Continue' : "Schedule Tour",
